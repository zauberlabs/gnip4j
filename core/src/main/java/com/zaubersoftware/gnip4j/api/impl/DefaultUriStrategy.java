...
public final class DefaultUriStrategy implements UriStrategy {
    ...
    public URI createRulesUri(final String account, final String streamName) {
        ...
        return URI.create(String.format(Locale.ENGLISH, ruleUrlBase + PATH_GNIP_RULES_URI, account.trim(), publisher.trim(), streamName.trim()));
    }
    ...
    public URI createRulesValidationUri(String account, String streamName) {
        // There is no rule validation end-point for API v1.
        return null;
    }
