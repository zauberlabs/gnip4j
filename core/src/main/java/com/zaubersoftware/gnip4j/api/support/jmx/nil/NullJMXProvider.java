 ...
 */
package com.zaubersoftware.gnip4j.api.support.jmx.nil;
...
/**
 * Null implementation for {@link JMXProvider}
 * 
 * @author Juan F. Codagnone
 * @since May 26, 2011
 */
public class NullJMXProvider implements JMXProvider {
    ...
    @Override
    public void unregister(final GnipStream stream) {
        // nothing to do
    }
